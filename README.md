...
- `wiz-agent`: AI-driven disk space analysis and intelligent cleanup for Windows. Uses WizTree for fast scanning, generates detailed space reports, and provides safe cleanup commands for dev caches, system temp files, and more.
